...
const fs = require('yargs/node_modules/fs')
...
const path = require('yargs/node_modules/path')
const Usage = require('yargs/lib/usage')
const Validation = require('yargs/lib/validation')
const Y18n = require('yargs/node_modules/y18n')
const objFilter = require('yargs/lib/obj-filter')
const setBlocking = require('yargs/node_modules/set-blocking')
...
function Yargs (processArgs, cwd, parentRequire) {
  ...
  self.commandDir = function (dir, opts) {
    ...
    command.addDirectory(dir, self.getContext(), req, require('yargs/node_modules/get-caller-file')(), opts)
    return self
  }
  ...
  function pkgUp (rootPath) {
    ...
    const findUp = require('yargs/node_modules/find-up')

    let obj = {}
    try {
      let startDir = rootPath || require('yargs/node_modules/require-main-filename')(parentRequire || require)
  ...
  function guessLocale () {
    ...
    try {
      const osLocale = require('yargs/node_modules/os-locale')
